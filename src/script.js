...
gui.add(door.material, 'displacementScale').min(0).max(1).step(0.01)
...
const skyTweaks = gui.addFolder('Sky')
skyTweaks.close()
skyTweaks
...
let doorLightUpdateTime = 0
const doorLightUpdateFrequency = 1 / 60
...
const tick = () => {
  ...
  ghost3.position.y =
    ...
    Math.sin(ghost3Angle * 3.5)

  // Door light
  if (elapsedTime - doorLightUpdateTime > doorLightUpdateFrequency) {
    doorLightUpdateTime = elapsedTime
